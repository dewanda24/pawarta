...
// Automation Engine
// ==========================================
export async function createAutomationRule(data: { nama: string; triggerEvent: string; conditions: any; actions: any }) {
  const user = await requireAuth();
...
// ==========================================
export async function generateSignatureRequest(data: { entityType: string; entityId: string; signers: string[]; tipe: string }) {
  const user = await requireAuth();
