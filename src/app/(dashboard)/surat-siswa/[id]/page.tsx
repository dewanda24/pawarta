...
export default async function DetailSuratSiswaPage({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="print-page bg-white p-4 sm:p-10 md:p-14 rounded-xl border border-gray-200 shadow-sm print:border-none print:shadow-none print:p-0 text-gray-950 font-serif leading-relaxed overflow-x-auto">
