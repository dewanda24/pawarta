...
async function main() {
  ...
  try {
    ...
    await db.execute(
      sql`TRUNCATE TABLE master_sekolah, master_pegawai, master_jabatan, master_unit_kerja, master_instansi, master_jenis_surat, master_prioritas, master_sifat_surat CASCADE`,
    );
    ...
    const pegawais = [
      {
        ...
        unitKerjaId: unitKerjas[0].id,
        jabatanId: jabatans[0].id,
        statusAsn: 'PNS',
        isAktif: true,
        ...defaultFields,
      },
      {
        ...
        unitKerjaId: unitKerjas[1].id,
        jabatanId: jabatans[1].id,
        statusAsn: 'PNS',
        isAktif: true,
        ...defaultFields,
      },
      {
        id: crypto.randomUUID(),
        nama: 'Ahmad Fauzi',
        nip: '199008082015011003',
        email: 'ahmad@example.com',
        unitKerjaId: unitKerjas[2].id,
        jabatanId: jabatans[2].id,
        statusAsn: 'PNS',
        isAktif: true,
        ...defaultFields,
      },
    ...
    const instansis = [
      {
        id: crypto.randomUUID(),
        nama: 'Kementerian Agama Provinsi',
        jenis: 'Instansi Pemerintah',
        kota: 'Jakarta',
        email: 'kanwil@kemenag.go.id',
        isAktif: true,
        ...defaultFields,
      },
      {
      ...
      {
        id: crypto.randomUUID(),
        nama: 'Universitas Islam Negeri',
        jenis: 'Perguruan Tinggi',
        kota: 'Jakarta',
        email: 'rektorat@uin.ac.id',
        isAktif: true,
        ...defaultFields,
      },
    ];
    ...
    // 6. Master Jenis Surat (Sesuai Perbup Sumedang No. 9/2026)
    console.log('Inserting Master Jenis Surat (Perbup Sumedang 9/2026)...');
    const jenisSurat = [
      {
        id: crypto.randomUUID(),
        kode: 'UND',
